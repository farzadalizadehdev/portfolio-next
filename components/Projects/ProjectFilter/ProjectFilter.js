...
const ProjectFilter = (props) => {
  ...
  return (
    <ul className="container sticky z-20 flex items-center justify-center h-20 max-w-screen-xl px-8 mx-auto text-sm bg-white dark:bg-neutral-900 md:justify-start top-16">
      <li
